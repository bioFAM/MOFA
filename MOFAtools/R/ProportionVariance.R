...
#' (default) Non-bayesian approach 2: one could argue that the non-bayesian approach 1 is not reliable because factors could have a lot of meaningless variance associated with it.
...
#' @param method (ignore)
#' @details fill this
#' @return fill this  a matrix with dim (M,K) with the proportion of residual variance explained by each factor
