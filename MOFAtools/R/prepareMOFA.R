...
#'  \item{\strong{learnFactors}:}{ logical indicating whether to automatically learn the number of factors. 
...
#'  \item{\strong{DropFactorThreshold}:}{ numeric indicating the threshold on fraction of variance explained 
#'  to consider a factor inactive and drop it from the model.
...
getDefaultTrainOptions <- function() {
  TrainOptions <- list(
    ...
    learnFactors = FALSE,         # (logical) learn the number of factors?
