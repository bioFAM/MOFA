...
df <- data.frame(
  ...
  culture = InputData(MOFAobject)[,order_samples]$culture,
  factor = factor1
)
...
```{r, message=FALSE}
cdr <- colMeans(TrainData(MOFAobject)$`RNA expression`>0,na.rm=TRUE)
