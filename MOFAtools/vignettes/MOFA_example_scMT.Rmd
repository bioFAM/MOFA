...
```{r}
scatterPairs(model, factors = c("2","3","4"), colour_by = sample_metadata[sampleNames(model),]$culture)
...
feature.sets <- readRDS("/Users/ricard/data/reactome/v59/mus_musculus/out/mouse_v75_reactome.rds")
# msigdb <- readRDS("/Users/ricard/data/MSigDB/v6.0/mus_musculus/C5/bp_binary_matrix_ensembl.rds")
