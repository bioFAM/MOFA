...
```{r}
scatterPairs(object, factors = c("2","3"), showMissing = F)
...
```{r}
showDataHeatmap(model, view="expr", factor="2", nfeatures=50)
...
FSE.out <- FeatureSetEnrichmentAnalysis(model, view = "mRNA", feature.sets = reactome)
